...
(peso_kg <- 55) # pero al poner paréntesis alrededor de la llamada imprime el valor de `weight_kg`
peso_kg # y también lo hace al escribir el nombre del objeto
```
...
masa <- masa * 2.0 # masa?
edad <- edad - 20 # edad?
índice_masa <- masa/edad # índice_masa?
```
